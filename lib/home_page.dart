...
import 'package:flutter_student_information/update_notes.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future deleteNote(int id) async {
    ...
    if(check>0){
      Fluttertoast.showToast(msg: "Student Info deleted successfully");
      loadAllNotes();
    }
    else
    {
      Fluttertoast.showToast(msg: "Failed to delete student info");
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: notes.isEmpty
          ? const Center(child: Text("No student info available!",style: TextStyle(
          color: Colors.green
      ),))
          : ListView.builder(
